function forbidden_control() {
    ...
    function() {
        function e() {
            ...
            if (new Date - e > 10) {
                try {
                    document.getElementsByTagName("html")[0].innerHTML = '<div style="width: 100%;height: 50px;font-size: 30px;text-align: center;font-weight: bold;">啊这个网站炸了，<a href="https://bt.siteweb.cn/" style="color:#4285f4;">点击返回</a>试试吧~</div>'
                } catch (e) {}
                return document.body.innerHTML = '<div style="width: 100%;height: 50px;font-size: 30px;text-align: center;font-weight: bold;">啊这个网站炸了，<a href="https://bt.siteweb.cn/" style="color:#4285f4;">点击返回</a>试试吧~</div>', !0
            }
            return !1
        }
...
if(window.location.href == 'https://siteweb.cn/'||window.location.href == 'https://siteweb.cn/'||window.location.href == 'https://siteweb.cn/'||window.location.href == 'https://blog.sianx.com/'){
    Snackbar.show({ actionText: '关闭',text: '欢迎来到丨御网尚书丨的互联网网站主页！',backgroundColor: '#9c9',actionTextColor: '#ffffff',pos: 'bottom-center',duration: '5000' });
  }